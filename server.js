...
const mongodb = require('./db/connect');s
// const passport = require('passport');
// const session = require('express-session');
// const GithubStrategy = require('passport-github2').Strategy;

// GitHub OAuth is temporarily disabled.
// We'll enable it later once we add our shared OAuth credentials to our single Render project.
// For now, this keeps the server running without requiring clientID/clientSecret. — Analina
